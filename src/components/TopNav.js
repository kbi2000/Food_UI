    ...
    return(
        <div className="max-w-[1520px] mx-auto flex justify-between items-center p-4">
            <div className="flex items-center ">
                ...
                <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">Try<span className="font-bold">Eats</span></h1>
            ...
            <div className="bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w[400px] lg:w[500px]">
                  ...
                  <input className="bg-transparent p-2 w-full rounded-full focus:outline-none " type="text" placeholder="search food">

                  </input>
            </div>
            <button className="bg-orange-700 text-white hidden md:flex items-center py-2 rounded-full">
               <BsFillCartFill size={25}></BsFillCartFill> Cart
            </button>
            {
                sideNav? (
            ...
            'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300"'}>
                <AiOutlineClose size={25} onClick={()=>setSideNav(!sideNav)} className="absolute right-4 top-4 cursor-default"></AiOutlineClose>
             <h2 className="text-2xl p-4"> Try <span className="text-orange-700">Eats</span></h2>
             <nav>
